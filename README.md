...
-   Support for Parity's
    ...
    client APIs
-   Support for [Alchemy](https://docs.alchemyapi.io/alchemy/guides/getting-started#web-3-j), [Infura](https://infura.io/) and [Nodereal](https://nodereal.io/), so you don't have to run
